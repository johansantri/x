  ...
  <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="title" style="text-align: center;">
            ...
            <form action="<?php base_url("dosen/edit") ?>" method="post"
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
                 type="text" name="nama" placeholder="nama" value="<?php echo $dosen->nama ?>" />
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('no_hp') ? 'is-invalid':'' ?>"
                 type="text" name="no_hp" min="0" placeholder="no hp" value="<?php echo $dosen->no_hp ?>" />
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('email') ? 'is-invalid':'' ?>"
                 type="email" name="email" min="0" placeholder="email" value="<?php echo $dosen->email ?>" />
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('email') ? 'is-invalid':'' ?>"
                 type="text" name="NIDN" min="0" placeholder="NIDN" value="<?php echo $dosen->NIDN ?>" />
                <div class="invalid-feedback">
            ...
            <div class="row">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('universitas') ? 'is-invalid':'' ?>"
                 type="text" name="universitas" min="0" placeholder="universitas" value="<?php echo $dosen->universitas ?>" />
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('kode_pt') ? 'is-invalid':'' ?>"
                 type="text" name="kode_pt" min="0" placeholder="Company" value="<?php echo $dosen->kode_pt ?>" />
                <div class="invalid-feedback">
                ...
                <input class="form-control <?php echo form_error('matakuliah') ? 'is-invalid':'' ?>"
                 type="text" name="matakuliah" min="0" placeholder="address" value="<?php echo $dosen->matakuliah ?>" />
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control <?php echo form_error('karir') ? 'is-invalid':'' ?>"
                 name="karir" placeholder="Description..."><?php echo $dosen->karir ?></textarea>
                <div class="invalid-feedback">
               ...
               <div class="form-group">
                ...
                <textarea class="form-control <?php echo form_error('penelitian') ? 'is-invalid':'' ?>"
                 name="penelitian" placeholder="Description..."><?php echo $dosen->penelitian ?></textarea>
                <div class="invalid-feedback">
               ...
               <div class="form-group">
                ...
                <textarea class="form-control <?php echo form_error('prestasi') ? 'is-invalid':'' ?>"
                 name="prestasi" placeholder="Description..."><?php echo $dosen->prestasi ?></textarea>
                <div class="invalid-feedback">
                ...
                <input type="hidden" name="old_image" value="<?php echo $dosen->image ?>" />
                <div class="invalid-feedback">
